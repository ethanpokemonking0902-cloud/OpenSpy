...
export default function SharePanel({ mapView, activeLayers, mouseCoords }: SharePanelProps) {
  ...
  const generateShareUrl = useCallback(() => {
    ...
    const base = typeof window !== 'undefined' ? window.location.origin : 'https://openspy.live';
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-12 right-0 w-72 glass-panel p-4 pointer-events-auto backdrop-blur-md z-[300]"
          >
            ...
            <div className="mb-3">
              ...
              <div className="flex gap-1.5">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded text-[7px] font-mono tracking-widest transition-all ${copied ? 'bg-[#E0E0E0]/20 text-[#E0E0E0] border border-[#E0E0E0]/30' : 'bg-[var(--gold-primary)]/10 text-[var(--gold-primary)] border border-[var(--gold-primary)]/30 hover:bg-[var(--gold-primary)]/20'}`}
                >
            ...
            <div className="flex gap-2">
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('🔮 OpenSpy — Global Intelligence Dashboard')}&url=${encodeURIComponent(generateShareUrl())}`}
                target="_blank"
              ...
              <a
                href={`https://reddit.com/submit?url=${encodeURIComponent(generateShareUrl())}&title=${encodeURIComponent('OpenSpy — Open Source Global Intelligence Platform')}`}
                target="_blank"
