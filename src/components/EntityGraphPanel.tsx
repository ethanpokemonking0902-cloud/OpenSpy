...
const TYPE_COLORS: Record<string, string> = {
  aircraft: '#00E5FF', vessel: '#00BCD4', company: '#FFFFFF',
  person: '#B388FF', country: '#76FF03', event: '#D0D0D0', sanction: '#FF1744',
  ip: '#D0D0D0',
};
      ...
      >
        <style>{`
          .scanline {
            ...
            background: linear-gradient(to bottom, rgba(255,255,255,0), rgba(255,255,255,0) 50%, rgba(255,255,255,0.03) 50%, rgba(255,255,255,0.03));
            background-size: 100% 4px;
            z-index: 10;
          }
          .hud-corner {
            position: absolute; width: 16px; height: 16px; border-color: rgba(255,255,255,0.4); border-style: solid; z-index: 20; pointer-events: none;
          }
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-[var(--border-primary)] bg-[var(--gold-primary)]/5 relative z-20">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[12px] font-mono font-bold tracking-[0.2em] text-[var(--gold-primary)]">[ OpenSpy // ENTITY INTEL ]</span>
        ...
        {entity ? (
          ...
          <div className="px-6 py-3 border-b border-[var(--border-primary)] flex items-center gap-3 bg-black/20 relative z-20">
            <Network className="w-4 h-4 text-[var(--gold-primary)]/50 animate-pulse" />
          ...
          {selectedNode && (
            ...
            >
              <div className="flex items-center justify-between mb-3 border-b border-[var(--border-secondary)] pb-2">
                <div className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 bg-[var(--gold-primary)] animate-pulse shadow-[0_0_8px_var(--gold-primary)]" />
