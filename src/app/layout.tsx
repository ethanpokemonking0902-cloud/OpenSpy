...
const SITE_URL = "https://openspy.live";
const SITE_NAME = "OpenSpy";
const SITE_TITLE = "OpenSpy — Global Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
const SITE_DESCRIPTION = "The intelligence platform. Track 10,000+ aircraft, 2,000 satellites, and worldwide CCTV cameras in real-time on a 3D globe. Run Nmap scans, DNS lookups, WHOIS queries, SSL cert analysis & threat intelligence — all from your browser. 20+ live data feeds including earthquakes, wildfires, nuclear facilities, cyber threats, and global conflicts.";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | OpenSpy Intelligence",
  },
  ...
  keywords: [
    ...
    "OSINT", "intelligence platform", "global intelligence",
    ...
    // Brand
    "openspy", "openspyai", "openspy.live",
  ],
  authors: [{ name: "OpenSpy Project", url: SITE_URL }],
  creator: "OpenSpy Project",
  publisher: "OpenSpy Project",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "OpenSpy — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "OpenSpy — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ OpenSpy — Open Source Palantir Alternative | Live Tracking + OSINT Tools",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "OpenSpy",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "OpenSpy — OSINT Toolkit & Intelligence Platform",
  alternateName: ["OpenSpy", "OpenSpyAI", "OpenSpy OSINT"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name="OpenSpy Core">
          {children}
        </ErrorBoundary>
      </body>
    </html>
