  ...
  try {
    ...
    const [wikiResult, wdResult] = await Promise.allSettled([
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[OpenSpy] Wikipedia fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[OpenSpy] Wikidata fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
    ]);
